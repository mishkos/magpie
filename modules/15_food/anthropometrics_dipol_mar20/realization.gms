...
$Ifi "%phase%" == "sets" $include "./modules/15_food/anthropometrics_dipol_mar20/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/15_food/anthropometrics_dipol_mar20/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/15_food/anthropometrics_dipol_mar20/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/15_food/anthropometrics_dipol_mar20/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/15_food/anthropometrics_dipol_mar20/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/15_food/anthropometrics_dipol_mar20/presolve.gms"
$Ifi "%phase%" == "intersolve" $include "./modules/15_food/anthropometrics_dipol_mar20/intersolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/15_food/anthropometrics_dipol_mar20/postsolve.gms"
