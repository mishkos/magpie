...
equations
 ...
 q21_noimport_ind(i,k_notrade_ind)   Constrain on inports in Inida (mio. tDM per yer)
...
parameters
 ...
 oq21_noimport_ind(t,i,k_notrade_ind,type) Constrain on inports in Inida (mio. tDM per yer)
