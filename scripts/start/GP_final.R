...
#Maximum iterations number to attempt to fine an optimal solution
cfg$gms$s80_maxiter <- 5

#Change the results folder name
# cfg$title<-"Good_Practice_Nitrogen"
cfg$title<-"default"

# Results folder 
cfg$results_folder <- "output/f_dipol_switches/:title::date:"
...
cfg$input <- c("magpie4.1_default_apr19.tgz",
							 "additional_data_rev3.68.tgz",
							 "isimip_rcp-IPSL_CM5A_LR-rcp2p6-co2_rev38_c200_690d3718e151be1b450b394c1064b1c5.tgz",
							 "rev4.32_690d3718e151be1b450b394c1064b1c5_magpie.tgz",
							 "rev4.32_690d3718e151be1b450b394c1064b1c5_validation.tgz")
